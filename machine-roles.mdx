...
<Info>
  You're not locked into your choice. Change a machine's role anytime with [`server update --role`](/cli/server).
</Info>
...
<Card title="Using Your Laptop or PC as a Builder" icon="laptop" href="/laptop-builder">
  Don't have a server yet? Your existing computer can act as a Builder — see when this makes sense and how to set it up.
</Card>
